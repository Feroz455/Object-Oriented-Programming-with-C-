...
public:
    ...
    /**************Here is modified constructor**************/
    Account(char *name, char *accountNumber, char *typeOfAccount)
    {
        int len = strlen(name);
        name = new char[len+1];
...
public:
    ...
    /**************Here is modified constructor**************/
    cur_acct(char *name, char *accountNumber, char *typeOfAccount,float balance):
         Account(name, accountNumber, typeOfAccount),balance(balance)
    {
...
public:
    ...
    /**************Here is modified constructor**************/
    say_acct(char *name, char *accountNumber, char *typeOfAccount,float balance):
         Account(name, accountNumber, typeOfAccount),balance(balance)
    {
...
void startSavingsAccount(void)
{
    ...
    while(1)
    {
        ...
        case '1':
            ...
            cin >> temp2;
            person[count] = say_acct(temp,temp2,"savings",0.0);
            count++;
            break;
        case '2':
            if(count == 0)
...
void StarCurrentAccount()
{
    ...
    while(1)
    {
        ...
        case '1':
            ...
            cout << "Give Account number :- ";
            cin >> temp2;
            person[count] = cur_acct(temp,temp2,"savings",0.0);
            count++;
            break;
        case '2':
             if(count == 0)
